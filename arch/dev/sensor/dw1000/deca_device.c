 ...
 *
 * @brief This is the DW1000's low power listening mode interrupt service routine.
 * It handles the automatic RX re-enabling (if configured) and/or timeout events.
 */
